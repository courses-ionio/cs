...
1. Ατομική εργασία: A. [Βιογραφικό](https://github.com/courses-ionio/projects/blob/master/bonus/index.md), B. [Βιβλίο μαθήματος](https://github.com/courses-ionio/projects/blob/master/social/index.md).

2. Ομαδική εργασία: A [Ιστοσελίδα τμήματος](https://github.com/ioniodi/site-gr), B.

3. Επιστημονικό άρθρο: Παρουσίαση της ομαδικής εργασίας 2 σε μορφή (π.χ., [1](https://pandoc-scholar.github.io/), [2](http://pierog.it/en/2018/03/markdown-workflow/) επιστημονικού άρθρου
