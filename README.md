...
Το μάθημα γίνεται με εκπόνηση συνεργατικών εργασίων που περιγράφονται στην παρακάτω ενότητα.
...
1. [Συνεργατική κατασκευή](https://github.com/courses-ionio/projects): Ιστοσελίδα τμήματος, Εύκολα: 15 Μαρτίου, Δύσκολα:10 Απριλίου
