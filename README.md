...
1. [Συνεργατική κατασκευή](https://github.com/ioniodi/site-gr): Ιστοσελίδα τμήματος, Εύκολα: 20 Μαρτίου, Δύσκολα:10 Απριλίου

2. Συνεργατική συγγραφή: Παρουσίαση της ομαδικής εργασίας 1 σε μορφή επιστημονικού άρθρου, το οποίο έχει γραφτεί με ανοικτές τεχνολογίες-διαδικασίες, π.χ., [1](https://pandoc-scholar.github.io/), [2](http://pierog.it/en/2018/03/markdown-workflow/), 10 Μαϊου
